...
/**
 * A small helper function to use with array_walk. Modifies a by-references
 * value and makes it lowercase.
 *
 * @param string $val a value passed by-references.
 * @return		void since it modifies a by-references value.
 */
 ...
 *
 * @param string $attvalue the by-references value to check.
